        ...
        <div class="x_panel">
            <div class="x_title">
                <div class="col-md-8 col-sm-8 col-xs-8">
                    <h2><small>Listado de documentos solicitados</small></h2>
                </div>
                <div class="col-md-4 col-sm-4 col-xs-4"> 
                    <a class="btn btn-success btn-sm" href="{{ route('Documento.create') }}"><i class="fa fa-plus"></i> Agregar</a>
                    ...
                    <tbody>
                        @foreach($Doc as $doc)
                            <tr>                                
                                <td>{{ $doc->NomTip}}</td>
                                <td>{{ $doc->DesTip}}</td>                                
                                <td> <a class="btn btn-primary btn-xs" href="{{ route('Documento.edit',$doc->IdTip) }}"><i class="fa fa-edit "></i></a></td>                                                        
                            </tr>
                        @endforeach
                    </tbody>
                </table>
