        ...
        <div class="x_panel">
            <div class="x_title">
                <div class="col-md-8 col-sm-8 col-xs-8">
                    <h2><small>Listado de documentos por solicitante</small></h2>
                </div>
                <div class="col-md-4 col-sm-4 col-xs-4"> 
                    <a class="btn btn-success btn-sm" href="{{ route('Documentos.create') }}"><i class="fa fa-plus"></i> Agregar</a>
                        ...
                        @foreach($Doc as $doc)
                            <tr>                                
                                ...
                                <td>
                                    ...
                                    @endif
                                    @if($doc->EstDso=='2')
                                        <span class="badge badge-dark">In-Activo</span>
                                    @endif    
                                </td>                                  
                                <td> <a class="btn btn-primary btn-xs" href="{{ route('Documentos.edit',$doc->IdDso) }}"><i class="fa fa-edit "></i></a></td>                                                        
                            </tr>
                        @endforeach
                    </tbody>
                </table>
