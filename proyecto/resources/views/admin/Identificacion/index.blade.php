        ...
        <div class="x_panel">
            <div class="x_title">
                <div class="col-md-8 col-sm-8 col-xs-8">
                    <h2><small>Tipos de documentos de identificación</small></h2>
                </div>
                <div class="col-md-4 col-sm-4 col-xs-4"> 
                    <a class="btn btn-success btn-sm" href="{{ route('Identidad.create') }}"><i class="fa fa-plus"></i> Agregar</a>
                    ...
                    <tbody>
                        @foreach($Ide as $ide)
                            <tr>                                
                                <td>{{ $ide->NomTid}}</td>
                                <td>{{ $ide->DesTid}}</td>                                
                                <td> <a class="btn btn-primary btn-xs" href="{{ route('Identidad.edit',$ide->IdTid) }}"><i class="fa fa-edit "></i></a></td>                                                        
                            </tr>
                        @endforeach
                    </tbody>
                </table>
